      ...
      <section id="contato" className="px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 rounded-[2.5rem] border border-[#54ffbf]/20 bg-[#071018] p-6 shadow-[0_30px_120px_rgba(84,255,191,.08)] md:p-10 lg:grid-cols-[.9fr_1.1fr]">
          <div>
            ...
            <div className="mt-8 space-y-3 text-slate-300"><p><Phone className="mr-3 inline h-5 w-5 text-[#54ffbf]" />+55 (11) 99999-0000</p><p><Mail className="mr-3 inline h-5 w-5 text-[#54ffbf]" />comercial@fltecnologia.com.br</p></div>
          </div>
          <form className="glass grid gap-4 rounded-[2rem] p-5 md:grid-cols-2" action="mailto:comercial@fltecnologia.com.br">
