...
if (command === "dev" || command === "start") {
  ...
  server.listen(port, "0.0.0.0", () => {
    console.log(`▲ Next.js 15.3.2-local`);
    console.log(`✓ FL TECNOLOGIA preview ready`);
    console.log(`  Local:   http://localhost:${port}`);
    console.log(`  Network: http://0.0.0.0:${port}`);
    console.log(`  Health:  http://localhost:${port}/health`);
    console.log("✓ Serving preview.html for local visual review");
    console.log("ℹ If this runs inside a remote container, open the forwarded port URL provided by your IDE instead of your computer's localhost.");
  });
} else {
